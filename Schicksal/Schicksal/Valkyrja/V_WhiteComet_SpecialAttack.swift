...
struct SK_WhiteComet_CometFall_Punt_Explanation: Explanation {
...
struct SK_WhiteComet_CometFall_Punt: MainSubskill {
    let explanation: Explanation = SK_WhiteComet_CometFall_Punt_Explanation()
    let skillType: SkillType = .comboSkill
}

extension SK_WhiteComet_CometFall_Punt {
    var physicalDamageTransform: Percentage { return 0.50 }
}

// MARK: - Comet Fall - Bring Down
struct SK_WhiteComet_CometFall_BringDown_Explanation: Explanation {
...
struct SK_WhiteComet_CometFall_BringDown: MainSubskill {
    let explanation: Explanation = SK_WhiteComet_CometFall_BringDown_Explanation ()
    let skillType: SkillType = .comboSkill
}

extension SK_WhiteComet_CometFall_BringDown {
    var physicalDamageTransform: Percentage { return 2.750 }
}

// MARK: - Comet Fall
struct SK_WhiteComet_CometFall_Explanation: Explanation {
...
struct SK_WhiteComet_CometFall: MainSkill {
    let explanation: Explanation = SK_WhiteComet_CometFall_Explanation()
    let skillType: SkillType = .comboSkill
    let mainSubskills: [MainSubskill] = [SK_WhiteComet_CometFall_Punt(), SK_WhiteComet_CometFall_BringDown()]
}

// MARK: - Comet Explosion
struct SK_WhiteComet_CometExplosion_Explanation: Explanation {
...
struct SK_WhiteComet_CometExplosion: SubSkill {
    let explanation: Explanation = SK_WhiteComet_CometExplosion_Explanation()
    let skillType: SkillType = .switchSkill
    let skillUnlockRank: SkillUnlockRank = .none
}

extension SK_WhiteComet_CometExplosion {
    var physicalDamageTransform: Percentage { return 2.75 }
}

// MARK: - Top Helix
struct SK_WhiteComet_TopHelix_Explanation: Explanation {
...
struct SK_WhiteComet_TopHelix: SubSkill {
    let explanation: Explanation = SK_WhiteComet_TopHelix_Explanation()
    let skillType: SkillType = .QTE
    let skillUnlockRank: SkillUnlockRank = .none
}

extension SK_WhiteComet_TopHelix {
    var physicalDamageTransform: Percentage { return 3.75 }
    var physicalDamagePlus: Increment { return 2250.0 }
}

// MARK: - Gravity Freak
struct SK_WhiteComet_GravityFreak_Explanation: Explanation {
...
struct SK_WhiteComet_GravityFreak: SubSkill {
    let explanation: Explanation = SK_WhiteComet_GravityFreak_Explanation()
